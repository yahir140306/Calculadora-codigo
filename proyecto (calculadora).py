...
class Interfaz:
    def __init__(self, ventana):
        #iciciar o darle un titulo a la ventana
        self.ventana=ventana
        self.ventana.title ("calculadora")

        #Agrega una caja de texto para que sea la pantalla de la calculadora
        ...
        #inicar la operacion mostrada en pantalla como string vacio
        self.operacion=""
    ...
    #crea un boton mostrando el valor pasado por parametro
    ...
    def click(self, texto, escribir):
        #si el parametro 'escribir' es true, entonces el parametro texto debe mostrarse en pantalla. si es flase, no.
        if not escribir:
            #solo calcular si hay una operacion a ser evaluada y si el usuario presiono '='
            if texto=="=" and self.operacion!="":
                #remplazar el valor unicode de la dicvision por el operador division de python '/'
            ...
            #si se presiono el boton de borrado, limpiar la pantalla
                ...
                #mostrar texto
                    ...
                    return
        #borra el contenido de la pántalla de la calculadora
                def limpiarPantalla(self):
                    self.pantalla.configure(state="normal")
                    self.pantalla.delete("1.0", END)
                    self.pantalla.configure(state ="disabled")
                    return
        #muestra en la pantalla de la calculadora el contenidp de las operaciones y los resultados
